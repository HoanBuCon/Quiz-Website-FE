      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-4 md:mb-0">
            <p className="text-white dark:text-primary-300 font-medium">
          ...
          <div className="flex space-x-8">
              <a
                ...
                onClick={(e) => {}}
                className="text-white dark:text-primary-300 hover:text-primary-200 dark:hover:text-primary-400 transition-all duration-300 font-medium hover:scale-105 transform"
              >
                Về chúng tôi
              </a>
              <a
